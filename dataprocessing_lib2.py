...
# видалення викидів
#data - масив данних без назви стовбців
# colums names - назва стовбців
# plotflag побудова графіку
#remove  - видалення викидів
#pandasform - вивід в форматі пандас якщо 0 то numpy
...
#notice_num кількість бажаних ознак
...
def class_coding(*classesmasives,clases_description = []):
